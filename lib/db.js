...
if (!global.db) {
  ...
  db.exec(`
    INSERT INTO my_dog_likes (name, image, thoughts, hearts) VALUES
      ...
      ('Cat sister Signe', '/images/signetailwag.gif', '["give kisses", "runs fast", "too cuddly"]', 0),
      ('Cat brother Otis', '/images/otistailwag.gif', '["loudmouth", "little scary", "very tiny"]', 0),
      ('Duck friend Thomas', '/images/thomasgif.gif', '["strange creature", "he funny", "important"]', 0),
      ('Meatballs', '/images/meatball.gif', '["top currency", "drool lvl 9000", "smells like yes"]', 0),
      ('Barking', '/images/viggobark.gif', '["how I solve problem", "very urgent", "much decibel"]', 0)
