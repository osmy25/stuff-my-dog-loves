...
if (!global.db) {
  ...
  const items = [
    ...
    },
    {
      ...
      thoughts: '["much yum", "*cronch* *cronch*", "gone in millisecond", "where did it go?", "ok i can take one more"]',
    },
    {
      id: 9,
      name: "The green ball",
      image: "/images/greenball.gif",
      thoughts: '["just the best ever", "best squeeze", "also big bounce", "i chase, always catch"]',
    },
  ];
