...
if (!global.db) {
  ...
  const items = [
    ...
    },
    {
      ...
      thoughts: {
        normal: ["just watching", "interesting...", "i do dishes"],
    ...
    },
    {
      ...
      thoughts: {
        ...
        legendary: ["...no secrets", "...this is fine"],
      },
    },
    {
      id: 21,
      ...
      thoughts: {
        ...
        legendary: ["...always bestest", "...pretty and bestest"],
      },
    },
    {
      id: 22,
    ...
    },
    {
      id: 23,
      sort_order: 2,
      name: "Carrying his 'girlfriend'",
      image: "/images/carrygirlfriend.gif",
      thoughts: {
        normal: ["we are going outside", "we have plans", "we are adventuring"],
        rare: ["very serious relationship", "girlfriend enjoys fresh air"],
        legendary: ["...together against the world", "...never leaving her behind"],
      },
    },
    {
      id: 24,
