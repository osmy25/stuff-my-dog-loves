  ...
  const items = [
    ...
    },
    {
      ...
      thoughts: {
        ...
        legendary: ["...knows i took biscuit", "...tiny but mighty"],
      },
    },
    {
      id: 5,
      ...
      thoughts: {
        normal: ["strange creature", "is he dog?", "not dog", "what if dog?", "he funny", "important"],
        rare: ["wise duck", "he knows things", "mystery bird"],
        legendary: ["...seen beyond", "...not just duck", "...knows all", "...ancient duck wisdom"],
      },
    },
    {
      id: 6,
